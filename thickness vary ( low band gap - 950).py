...
g1=0*varyThickness
g2=0*varyThickness
g3 = [[0 for x in np.arange(columns)] for y in np.arange(rows)]
...
#ax4.set_ylim(ymin=0)
#ax4.set_title('delta generation rate vs thickness (wide band gap)')
#ax4.set_ylabel('g1-g2')
#ax4.set_xlabel('Layer Thickness , nm')
#ax4.set_ylim(top=ceil(sorted(g1-g2)[-1]))
#ax4.plot(varyThickness,g1-g2)
fig4.show()
